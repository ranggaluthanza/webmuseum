	...
	<div class="section wb">
      <div class="container">
        <div class="row">
          ...
          <?php 
          $id=$_GET['id'];
          $fas=$user->detail_berita($id);
          $f=$user->detail_admin($fas['username']);
          $tambahview=$user->tambah_view($id);
          $thn=date("Y", strtotime($fas['tanggal']));
          $tanggal=date("M d", strtotime($fas['tanggal']));
          $dibaca=number_format($fas['dibaca']+1);
          ?>          
            <p class="mb-5">
              <img src="<?php echo "$d[url]"?>/foto_berita/<?echo "$fas[gambar]"?>" alt="Image" class="responsive" >
            </p>  
            <h1 class="mb-4">
				<?echo "$fas[judul]"?>
            </h1>
            <div class="post-meta d-flex mb-5">
              ...
              <div class="vcard">
                <span class="d-block"><a href="#"><?echo "$f[nama_admin]"?></a> in <a href="#"><?echo "$fas[sumber]"?></a></span>
                <span class="date-read"><?echo "$tanggal"?> <span class="mx-1">&bullet;</span> <?echo "$dibaca"?>  read <span class="icon-star2"></span></span>
              </div>
            </div>
